...
\begin{figure}[!htb]
\centering
\subfigure[AETAIS-RW algorithm adapting variance.]{\includegraphics[width=0.495\textwidth]{"figures/G1_ETAISRW_adapt_var"}}
\subfigure[AETAIS-RW algorithm maximising ESS.]{\includegraphics[width=0.495\textwidth]{"figures/G1_ETAISRW_adapt_ess"}}
\subfigure[AETAIS-MALA algorithm adapting variance.]{\includegraphics[width=0.495\textwidth]{"figures/G1_ETAISMALA_adapt_var"}}
\subfigure[AETAIS-MALA algorithm maximising ESS.]{\includegraphics[width=0.495\textwidth]{"figures/G1_ETAISMALA_adapt_ess"}}
...
\subfigure[ETAIS-RW algorithm.]{\includegraphics[width=0.45\textwidth]{"figures/G2_paiso"}}
...
\begin{figure}[ht]
\begin{center}
\includegraphics[width=0.6\textwidth]{"figures/ETAIS_saving"}
...
\subfigure[Convergence of locally optimised ETAIS-RW with scout chain,
and globally optimised ETAIS-RW and RWMH.]
...
\begin{figure}[htb]
\centerfloat
\includegraphics[width=1.2\textwidth]{"figures/ETAIS_best_posterior"}
