...
approximate the posterior {\red density $\pi$, with an ensemble
...
into a {\red set of new equally-weighted samples $\{x_i\}_{i=1}^M$, such that
...
\end{equation}}
{\red where $\delta_{x}(\cdot)$ is the Dirac delta measure.}
...
\section{{\red A useful property of the ETAIS algorithm for multimodal
