...
\subfigure[\hl{Cost of resamplers per significant figure}]{\includegraphics[width=0.45\textwidth]{"figures/Resampler_speed"}}\\
...
AMR preserve the mean of the original weighted samples up to machine precision. Figure \ref{fig:AMR} \hl{(d) shows how the computational cost,
