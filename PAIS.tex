...
however biased, consistency was proved in~\cite{marin2014consistency}.
...
from this point we
can iterate the process once again. The algorithm is summarised in Algorithm \ref{alg:PAIS}. 
