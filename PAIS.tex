...
\begin{figure}[htb]
\centering
\includegraphics[width=0.45\textwidth]{"figures/pCNL2 opt delta"}
\includegraphics[width=0.45\textwidth]{"figures/PAIS pCNL2 opt delta"}
...
remains significant. The PAIS-pCNL algorithm requires 45\% fewer
iterations than the naively parallelised pCNL algorithm.
